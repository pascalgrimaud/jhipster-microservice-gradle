...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "msgradle@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "msgradle API";

        private String description = "msgradle API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "msgradle";
